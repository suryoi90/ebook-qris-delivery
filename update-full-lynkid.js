...
// 1. Update app/api/checkout/route.js agar mendukung harga dinamis sesuai buku yang dipilih
...
// 2. Update app/page.js dengan desain persis Lynk.id (@restiapriw)
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#060b13', color: '#ffffff', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', padding: '40px 16px' }}>
      <div style={{ maxWidth: '480px', margin: '0 auto' }}>
        ...
        {/* HEADER PROFIL PERSIS LYNK.ID */}
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          
          {/* Avatar Hijab Illustration */}
          ...
          {/* Tombol Instagram */}
          <a href="https://instagram.com/restiapriw" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '38px', height: '38px', borderRadius: '50%', backgroundColor: 'transparent', border: '1.5px solid rgba(255,255,255,0.4)', color: '#ffffff', textDecoration: 'none', transition: '0.2s' }}>
        ...
        {/* DAFTAR 4 PRODUK PERSIS LYNK.ID */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginBottom: '40px' }}>
          {PRODUCTS.map((p) => (
            <div key={p.id} style={{ backgroundColor: '#ffffff', borderRadius: '18px', overflow: 'hidden', color: '#0f172a', boxShadow: '0 8px 24px rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)' }}>
              
              {/* Cover Tablet Mockup Visual */}
              <div style={{ padding: '24px 20px 16px', display: 'flex', justifyContent: 'center', backgroundColor: '#ffffff' }}>
                <div style={{ width: '100%', maxWidth: '340px', borderRadius: '24px', border: '7px solid #1e293b', backgroundColor: p.coverTheme, overflow: 'hidden', boxShadow: '0 12px 28px rgba(0,0,0,0.25)', position: 'relative' }}>
                  ...
                  <div style={{ backgroundColor: '#ffffff', margin: '0 8px 8px', borderRadius: '14px', padding: '20px 14px', textAlign: 'center', minHeight: '260px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    <div>
                      ...
                      {/* Icon Ilustrasi Gembok / Shield */}
                      <div style={{ margin: '14px auto', width: '60px', height: '60px', borderRadius: '14px', backgroundColor: '#f0f9ff', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #bae6fd' }}>
                        <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke={p.coverTheme} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* 3 Poin Fitur Box Persis Screenshot */}
        ...
        {selectedProduct && (
          <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(6px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px', zIndex: 9999 }}>
            <div style={{ backgroundColor: '#ffffff', borderRadius: '24px', maxWidth: '440px', width: '100%', padding: '24px', color: '#0f172a', position: 'relative', maxHeight: '90vh', overflowY: 'auto' }}>
              ...
              <h3 style={{ fontSize: '16px', fontWeight: '800', margin: '0 0 6px', color: '#0f172a', paddingRight: '24px', lineHeight: 1.3 }}>
              ...
              {!qris ? (
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ backgroundColor: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: '12px', padding: '10px', marginBottom: '14px' }}>
                    <div style={{ fontSize: '13px', fontWeight: 'bold', color: '#0369a1' }}>Scan QRIS untuk Menyelesaikan Pembayaran</div>
                    <div style={{ fontSize: '15px', fontWeight: '900', color: '#0284c7', marginTop: '2px' }}>IDR {selectedProduct.price.toLocaleString('id-ID')}</div>
                  </div>
                  ...
                  <div style={{ backgroundColor: '#f0fdf4', border: '1px solid #bbf7d0', padding: '10px 12px', borderRadius: '10px', fontSize: '12px', color: '#166534', textAlign: 'left' }}>
                    ⚡ <b>Otomatis:</b> PDF ber-watermark atas nama <b>{form.nama}</b> ({form.organisasi}) akan langsung terkirim ke email <b>{form.email}</b> setelah pembayaran.
                  </div>
                </div>
              )}
...
console.log('✅ Desain 4 Produk & Header Lynk.id 100% Persis Berhasil Dibuat!');